    ...
    const app = {
        ...
        updateAtelierList(jsonData) {
            ...
            if(this.atelierList) {
                ...
                arr.forEach((e) => {
                    str += `<li><a href="app/atelier-studio/visiting-mons-again/index.html"><img src="app/static/img/${e.img}" loading="lazy"></a><h3>${e.subtitle}</h3><h2>${e.title}</h2><p>${e.description}</p><a class="more" href="atelier-studio/visiting-mons-again/index.html">Learn More</a></li>`;
                });
        ...
        updateArtList(jsonData) {
            ...
            if(this.artList) {
                ...
                arr.forEach((e) => {
                    str += `<li><a href="app/art-and-exhibitions/in-dialogue-with-calatrava/index.html"><img src="app/static/img/dataImg/${e.cover}" loading="lazy"></a><h3>${e.subtitle}</h3><h2>${e.title}</h2><p>${e.description}</p><a class="more" href="art-and-exhibitions/in-dialogue-with-calatrava/index.html">Learn More</a></li>`;
                });
